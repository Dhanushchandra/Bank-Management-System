...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno){
        ...
        JLabel personDetails = new JLabel("Page 2: Additonal Details");
        ...
        String varReligion[] = {"Hindu","Muslim","Sikh","Christian"};
        ...
        String varCategories[] = {"General","OBC","SC","ST","Others"};
         category = new JComboBox(varCategories);
        ...
        ButtonGroup exisistgroup = new ButtonGroup();
        exisistgroup.add(eyes);
        exisistgroup.add(eno);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
                ...
                String query = "insert into signuptwo values('"+formno+"', '"+sreligion+"', '"+scategory+"', '"+sincome+"', '"+seducation+"', '"+soccupation+"', '"
                        +span+"', '"+saadhar+"', '"+senior+"', '"+exisitingAccount+"')";
